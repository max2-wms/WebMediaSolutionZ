...
?>
<aside id="sidebar" class="<?php esc_attr_e( $sidebar_classes ); ?>" style="<?php esc_attr_e( apply_filters( 'awb_aside_1_tag_style', '' ) ); ?>" data="<?php esc_attr_e( apply_filters( 'awb_aside_1_tag_data', '' ) ); ?>">
